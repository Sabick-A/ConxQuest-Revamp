  ...
  return (
    <div className="z-50 h-screen w-full flex items-center justify-center bg-whitesmoke opacity-90">
      <div
        ...
        className="p-4 mb-4 mx-10 text-yellow-800 border border-yellow-300 rounded-lg bg-yellow-50"
        role="alert"
      >
        ...
        <div className="flex">
          <button
            ...
            type="button"
            className="text-yellow-800 bg-transparent border border-yellow-800 hover:bg-yellow-900 hover:text-white focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium rounded-lg text-xs px-3 py-1.5 text-center "
