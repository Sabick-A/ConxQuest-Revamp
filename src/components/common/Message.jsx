  ...
  return (
    <div className="z-50 h-screen w-full flex items-center justify-center bg-whitesmoke opacity-90">
      <div
        ...
        class="p-4 mb-4 mx-10 text-yellow-800 border border-yellow-300 rounded-lg bg-yellow-50 dark:bg-gray-800 dark:text-yellow-300 dark:border-yellow-800"
        role="alert"
      >
        <div class="flex items-center">
          ...
          <h3 class="text-lg font-medium">Thank you for trying our game! 🎮{" "}</h3>
        </div>
